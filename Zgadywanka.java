...
public class Zgadywanka {
    ...
    public static void main(String[] args) {
        ...
        /* Wersja 2 - program posiada swoją bazę danych haseł i wybiera losowe do odgadnięcia */
...
//        haslo = baza_hasel[wylosowane];
        ...
        System.out.println("Witaj w grze zgadywanka! Zgadnij ukryte hasło podając literę, lub zgadując cały wyraz. W przypadku błędu masz 5 prób. Miłej zabawy!");
        
        /* Wersja 1 - użytkownik wprowadza hasło do odgadnięcia */
        
        System.out.println("Podaj hasło do odgadnięcia (bez polskich znaków)"); //w przypadku wersji 2 należy tą linijkę wrzucić pod komentarz
        haslo = odczyt.nextLine();                        //w przypadku wersji 2 należy tą linijkę wrzucić pod komentarz
